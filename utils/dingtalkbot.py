...
if __name__ == '__main__':
    ...
    msg = 'hello,dingtalk!'
    webhook = 'https://oapi.dingtalk.com/robot/send?access_token=1784415d3d8245535b2c3dda22e1eda0b767f7fb168cd772e3d666fb6cbc9a24'

    # 初始化
    dtalk = DingtalkChatbot(webhook=webhook)
    dtalk.send_text(msg=msg, at_mobiles=[])
